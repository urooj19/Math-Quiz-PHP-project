<?php
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='admin') 
    {
      ...
      header("location:welcome.php?q=5");
    }
  }
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='admin') 
    {
      ...
      header("location:welcome.php?q=4&step=2&eid=$id&n=$total");
    }
  }
  ...
  if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) 
  {
    ...
    {
      $sn++;
      header("location:../userpannel/dashboard.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total")or die('Error152');
    }
    else if( $_SESSION['key']!='suryapinky')
    {
      ...
      header("location:../userpannel/dashboard.php?q=result&eid=$eid");
    }
    else
    {
      header("location:../userpannel/dashboard.php?q=result&eid=$eid");
  ...
  if(@$_GET['q']== 'quizre' && @$_GET['step']== 25 ) 
  {
    ...
    $sun=$sun-$s;
    $q=mysqli_query($con,"UPDATE `rank` SET `score`=$sun ,time=NOW() WHERE email= '$email'")or die('Error174');
    header("location:../userpannel/dashboard.php?q=quiz&step=2&eid=$eid&n=1&t=$t");
  }
?>
