...
<?php
                    if(@$_GET['eq']==4 && !(@$_GET['step']) ) 
                    {
                        echo '<div class="row">
                        <h1 style="color: #ffc107"><center>Enter Exercise Quiz Details</center></h1>
                        <div class="col-md-3"></div>
                        <div class="col-md-6">   
                        <form class="form-horizontal title1" name="form" action="exupdate.php?q=addquiz"  method="POST">
                            <fieldset>
                            
                                <div class="form-group">
                                    <label class="col-md-12 control-label" for="chname"></label>  
                                    <div class="col-md-12">
                                        <input id="chname" name="chname" placeholder="Enter Chpater Name" class="form-control input-md" type="text">
                                    </div>
                                </div>
                ...
                <?php
                    if(@$_GET['eq']==4 && (@$_GET['step'])==2 ) 
                    {
                        ...
                        <br/><br/>
                        <div class="col-md-3"></div>
                        <div class="col-md-6"><form class="form-horizontal title1" name="form" action="exupdate.php?q=addqns&n='.@$_GET['n'].'&name='.@$_GET['name'].'&ch=4 "  method="POST">
                        <fieldset>
                        ';
                ...
                <?php 
                    if(@$_GET['eq']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            <td>
                            <center><b><a href="exupdate.php?q=rmquiz&name='.$name.'" class="pull-right btn sub1" style="margin:0px;background: #ffc107;color:black"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></center>
                            </td>
                            </tr>';
                        }
                        $c=0;
